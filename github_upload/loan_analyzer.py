...
print(f"There are {num_of_loans} number of loans available on the list")
...
print(f"The total cost of all available loans is ${sum_of_loans}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount

avg_loan_amount = sum_of_loans / num_of_loans
...
rem_loan_months = loan.get("remaining_months")
print(rem_loan_months)
...
present_value = future_value / (1 + 0.20/12) ** rem_loan_months
...
present_value= present_value_calc(
